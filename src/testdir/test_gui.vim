...
func Test_scrollbars()
  ...
  set scrolloff=0
  if has('gui_macvim')
    " MacVim's go-k works asynchronously. As such, it will mess up the
    " calculations here. Just don't use go-k here for now. May need to find a
...
func Test_Buffers_Menu()
  if !has('gui_macvim') " MacVim doesn't use LoadBufferMenu as it immediately loads the menu on launch
