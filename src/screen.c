...
# endif
	...
	{
# if !defined(FEAT_GUI_MSWIN) && !defined(FEAT_GUI_MACVIM) /* MacVim: see comment on subpixel antialiasing */
...
# if defined(FEAT_GUI_GTK) || defined(FEAT_GUI_MACVIM) // most of the time, it's not XIM being used
